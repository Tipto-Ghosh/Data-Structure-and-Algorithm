...
public:
    int minimumPushes(string word) {
        ...
        while(!pq.empty()) {
            ...
            map[ele.second] = press;
            button ++;
            // if button is greater than 9 then go back to button 2 again but increase the press
            if(button > 9) {
                press ++;
                button = 2;
            }
