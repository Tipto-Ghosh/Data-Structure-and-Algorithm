...
int main() {
    ...
    Solution s;
    string s1 = "aaabb" , s2 = "ababbc" , s3 = "ababacb";

    // cout << s.longestSubstring(s1 , 3) << endl;
    // cout << s.longestSubstring(s2 , 2) << endl;
    // cout << s.longestSubstring(s3 , 3) << endl; 

    string s4 = "bbaaacbd";
    cout << s.longestSubstring(s4 , 3);
