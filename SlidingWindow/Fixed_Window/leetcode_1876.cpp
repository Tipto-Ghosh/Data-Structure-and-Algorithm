...
public:
    int countGoodSubstrings(string s) {
        ...
        while(i3 < n) {
        	if(s[i1] != s[i2] && s[i1] != s[i3] && s[i2] != s[i3]) {
        		count ++;
        	}
        	i1 ++;
        	i2 ++;
...
int main() {
    ...
    string s1 = "abcdefghijklmnopqrstuvwxyx" , s2 = "aababcabc";

    int ans1 = sol.countGoodSubstrings(s1);
    int ans2 = sol.countGoodSubstrings(s2);
