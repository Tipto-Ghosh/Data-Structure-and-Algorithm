...
int main() {
    ...
    int ans1 = sol.lengthOfLongestSubstring("abcabcbb");
    int ans2 = sol.lengthOfLongestSubstring("bbbbb");
    int ans3 = sol.lengthOfLongestSubstring("pwkew");
