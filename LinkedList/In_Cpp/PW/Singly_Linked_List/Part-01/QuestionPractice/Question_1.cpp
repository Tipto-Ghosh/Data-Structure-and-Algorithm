...
void deleteAlternativeNodes(Node* &head , int alt){
      
    if(head == nullptr){ // If there is no node in the list do nothing
        return;
    }
    ...
    while(currentNode != nullptr && currentNode -> next != nullptr){
        // if currentNode != nullptr then it's a tail
