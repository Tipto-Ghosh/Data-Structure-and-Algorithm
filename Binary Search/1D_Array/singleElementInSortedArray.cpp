...
/*
  Case:1>> if mid is even
      >> if in the right i have same element then single element is in the right
      >> if in the left i have same element then single element is in the left

   Case:2>> If mid is odd
      >> if in the left i have same element then single element is in the right
      >> if in the right i have same element then single element is in the left  
*/
...
public:
    int singleNonDuplicate(vector<int>& arr) {
        ...
        // now my search area is index 1 to n-2
