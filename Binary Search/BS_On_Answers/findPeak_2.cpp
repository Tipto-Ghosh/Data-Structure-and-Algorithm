...
public:
    vector<int> findPeakGrid(vector<vector<int>>& arr) {
        ...
        while(left <= right) {
            ...
            // find the maxRow in that middle col
        	int maxRow = 0;
            ...
            // check maxRow is a peak or not
            bool isLeftSmaller = (mid == 0) || (arr[maxRow][mid] > arr[maxRow][mid-1]);
            bool isRightSmaller = (mid == cols - 1) || (arr[maxRow][mid] > arr[maxRow][mid + 1]);
