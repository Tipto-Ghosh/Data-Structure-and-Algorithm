...
class Solution {
public:
    ll countOfSubstrings(string s, int k) {
...
void let_him_cook() {
   ...
   cout << s.countOfSubstrings("aeioqq" , 1) << endl;
   cout << s.countOfSubstrings("aeiou" , 0) << endl;  
   cout << s.countOfSubstrings("ieaouqqieaouqq" , 1) << endl;
   cout << s.countOfSubstrings("iqeaouqi" , 2) << endl;

   cout << s.countOfSubstrings("auoeia" , 0) << endl;
}
//--------------------------Main Here-------------------------------
int main() {
