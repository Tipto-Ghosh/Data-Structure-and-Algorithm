...
int main() {
    ...
    vector<string> arr2 = {"00:00","23:59","00:00"};
    
    int ans = s.findMinDifference(arr);
    int ans2 = s.findMinDifference(arr2);
